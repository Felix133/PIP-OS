...
Rectangle {
        ...
        ListView {
            ...
            delegate: Item {
                ...
                Text {
                    ...
                    text: DwellerSettings["special" + stat]
                    color: item.ListView.isCurrentItem ? "black" : "white"
                    font.family: "Roboto Condensed"
                    font.pixelSize: 26
    ...
    Rectangle {
        ...
        AnimatedImage {
            ...
            // source: "/images/%1.gif".arg(list.currentItem.stat)
